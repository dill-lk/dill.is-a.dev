        ...
        <div className="opacity-80">
            <style>{`
                @keyframes drawShaft {
                    ...
                    10% { stroke-dashoffset: 400; opacity: 1; }
                ...
                @keyframes drawHead {
                    0%, 30% { stroke-dashoffset: 200; opacity: 1; }
            ...
            >
                ...
                <path
                    ...
                    style={{
                        strokeDasharray: 400,
                        animation: 'drawShaft 3s cubic-bezier(0.4, 0, 0.2, 1) infinite'
                    }}
                />
                {/* Shaft Fill */}
                <path
                    ...
                    fill="white"
                    style={{
                        animation: 'fillShaft 3s cubic-bezier(0.4, 0, 0.2, 1) infinite'
                    }}
                />
                ...
                <path
                    ...
                    style={{
                        strokeDasharray: 200,
                        animation: 'drawHead 3s cubic-bezier(0.4, 0, 0.2, 1) infinite'
                    }}
                />
                {/* Arrow Head Fill */}
                <path
                    ...
                    fill="white"
                    style={{
                        animation: 'fillHead 3s cubic-bezier(0.4, 0, 0.2, 1) infinite'
                    }}
                />
            </svg>
        </div>
